...
router.post(
  '/:id/comments',
  [auth, paramsValidation(['id']), commentValidation],
  commentController.addComment,
);
router.get(
  '/:idPost/comments/:bo',
  paramsValidation(['idPost', 'bo']),
  commentController.getComments,
);
router
  .route('/:idPost/comments/:idComment')
  .put(
    [auth, paramsValidation(['idPost', 'idComment']), commentValidation],
    commentController.updateComment,
  )
  .delete(
    [auth, paramsValidation(['idPost', 'idComment'])],
